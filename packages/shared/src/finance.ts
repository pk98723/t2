// Purchase decision analysis — pure, framework-agnostic logic shared by web + mobile.
...
// fmt is intentionally NOT duplicated here — it's exported from expense.ts to avoid re-export conflicts.